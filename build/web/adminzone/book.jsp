<%-- 
    Document   : book
    Created on : Sep 20, 2023, 11:02:10 AM
    Author     : Dell
--%>
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-2">
                ...
                <div class="col-sm-12" style="min-height: 600px; background-color: darkcyan">
                    <h2 style="color: white;text-align: center;">Booking Form</h2>
                    <%
                    ...
                    if(rs.next())
                    {
                     ...
                     <form class="form-group" method="post" action="admincontroller.jsp">
                         ...
                         <table class="table-bordered bg-white" style="margin: auto;width:70%;">
                             <tr>
